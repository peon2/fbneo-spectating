...
local icon_size, image_icon_size = 10 -- SET THIS TO CHANGE ICONS. DON'T GO UNDER 4 OR ABOVE 16
...
function togglescrollinginputsplayer()
	...
	elseif draw[1] and not draw[2] then
		draw[1] = false
	elseif not draw[1] and not draw[2] then
		draw[1] = true
		draw[2] = true
	end
end

input.registerhotkey(1, togglescrollinginputsplayer) -- Has to be here or script crashes
