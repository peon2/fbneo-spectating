...
col,inp,module = {},{}
dofile("spectating\\input-modules.lua","r")
...
function toggledisplay() display = not display end

input.registerhotkey(2, toggledisplay) -- Has to be here or script crashes
